...
public:
  ...
  {
    MinMaxVectors &vectors = _minmax_map[node];
    vectors.min_vector.insert(vectors.min_vector.end(), minmax_vector.min_vector.begin(), minmax_vector.min_vector.end());
    vectors.max_vector.insert(vectors.max_vector.end(), minmax_vector.max_vector.begin(), minmax_vector.max_vector.end());
  }
