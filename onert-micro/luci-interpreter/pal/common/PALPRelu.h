...
#ifndef LUCI_INTERPRETER_PAL_PRELU_H
#define LUCI_INTERPRETER_PAL_PRELU_H
...
inline void BroadcastPRelu4DSlowFloat(const luci_interpreter::RuntimeShape& unextended_input1_shape,
...
#endif // LUCI_INTERPRETER_PAL_PRELU_H
