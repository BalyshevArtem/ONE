...
template <>
inline void
FullyConnected<int8_t>(const luci_interpreter_pal::FullyConnectedParams &params,
...
template <>
inline void
FullyConnected(const luci_interpreter_pal::FullyConnectedParams &params,
               const int32_t *, const int16_t *input_data,
               const int32_t *filter_shape, const int8_t *filter_data,
