...
//  virtual void configure(std::vector<const Tensor *> &inputs, std::vector<Tensor *> &outputs, Params *params) = 0;
//
//  //template <typename Params>
//  //virtual void configure(std::vector<const Tensor *> &inputs, std::vector<Tensor *> &outputs, Params &params) = 0;
//
//  // Executes the kernel.
//  virtual void execute(std::vector<const Tensor *> &inputs, std::vector<Tensor *> &outputs, Params *params) const = 0;
//
