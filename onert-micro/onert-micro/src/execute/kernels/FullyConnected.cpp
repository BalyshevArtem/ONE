...
#ifndef DIS_QUANT
void calculateOpDataFullyConnected(const circle::Tensor *input,
...
OMStatus onert_micro::execute::execute_kernel_CircleFullyConnected(const OMExecuteArgs &execute_args)
{
  ...
  switch (input->type())
  {
    ...
    case circle::TensorType_INT8: {
      ...
      calculateOpDataFullyConnected(input, weight, output, options->fused_activation_function(), op_params);
    ...
    case circle::TensorType_INT16: {
      ...
      status = pal::FullyConnected(op_params, core::utils::castInputData<int16_t>(input_data),
                                   OMRuntimeShape(weight), core::utils::castInputData<int8_t>(weight_data),
                                   core::utils::castInputData<int32_t>(bias_data), OMRuntimeShape(output),
