...
TEST_F(AddTest, INT32_P)
{
  // No broadcast
  {
    ...
    std::vector<int32_t> output_data_vector = onert_micro::execute::testing::checkTISOKernel<int32_t>(&test_data_add_no_broadcasting);
    EXPECT_THAT(output_data_vector,
                test_data_add_no_broadcasting.get_output_data_by_index(0));
  }
  // With broadcast
  {
    const bool is_with_broadcast = true;
    test_model::TestData32IntAdd test_data_add_with_broadcasting(is_with_broadcast);
    std::vector<int32_t> output_data_vector = onert_micro::execute::testing::checkTISOKernel<int32_t>(&test_data_add_with_broadcasting);
    EXPECT_THAT(output_data_vector,
                test_data_add_with_broadcasting.get_output_data_by_index(0));
  }
}
...
TEST_F(AddTest, INT64_P)
{
  // No broadcast
  {
    ...
    std::vector<int64_t> output_data_vector = onert_micro::execute::testing::checkTISOKernel<int64_t>(&test_data_add_no_broadcasting);
    EXPECT_THAT(output_data_vector,
                test_data_add_no_broadcasting.get_output_data_by_index(0));
  }
  // With broadcast
  {
    ...
    std::vector<int64_t> output_data_vector = onert_micro::execute::testing::checkTISOKernel<int64_t>(&test_data_add_with_broadcasting);
    EXPECT_THAT(output_data_vector,
                test_data_add_with_broadcasting.get_output_data_by_index(0));
  }
}
...
TEST_F(AddTest, Float_P)
{
  // No broadcast
  {
    ...
    std::vector<float> output_data_vector = onert_micro::execute::testing::checkTISOKernel<float>(&test_data_float_add_no_broadcasting);
    EXPECT_THAT(output_data_vector,
  ...
  // With broadcast
  {
    ...
    std::vector<float> output_data_vector = onert_micro::execute::testing::checkTISOKernel<float>(&test_data_float_add_with_broadcasting);
    EXPECT_THAT(output_data_vector,
