...
public:
  ...
  {
#define REGISTER_CUSTOM_KERNEL(name, string_name)                                \
  registerKernelConfigure(core::OMBuilderID::CUSTOM_##name,                    \
                            configure_kernel_Circle##name);
...
private:
  KernelConfigureFunc *_operator_configure[size_t(core::OMBuilderID::Size) - size_t(core::OMBuilderID::BuiltinOperatorsSize) - 1];
};
